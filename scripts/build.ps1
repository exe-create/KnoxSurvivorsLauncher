...
@("Manifest-Version: 1.0", "Main-Class: com.knoxsurvivors.launcher.Main", "Implementation-Version: 0.3.0", "Knox-Update-Protocol: 1", "") | Set-Content (Join-Path $build 'MANIFEST.MF') -Encoding ascii
